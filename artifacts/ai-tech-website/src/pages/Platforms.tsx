      ...
      <section className="py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex-1 h-px bg-border" />
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-50 text-neutral-700 text-xs font-bold border border-neutral-100">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            >
              ...
              {/* Outcomes */}
              <div className="bg-gradient-to-br from-neutral-50 to-white border border-neutral-100 rounded-2xl p-8">
                <p className="text-xs font-bold uppercase tracking-widest text-neutral-600 mb-5">Key Outcomes</p>
                <ul className="space-y-3">
                  {taxOutcomes.map((o, i) => (
                    <motion.li
                      key={i}
              ...
              <div className="space-y-6 mb-12">
                {[
                  ...
                  <motion.div
                    ...
                    className="flex items-start gap-4"
                  >
                    <div className="w-9 h-9 rounded-xl bg-neutral-50 border border-neutral-100 flex items-center justify-center shrink-0 mt-0.5">
