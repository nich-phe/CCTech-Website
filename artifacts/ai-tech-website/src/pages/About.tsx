        ...
        >
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              CC TECH is an AI technology company focused on practical,
              sector-specific platforms. AI shouldn't just be an impressive demo
              — it should be a reliable engine for daily work.
            </p>
          </motion.div>
        </motion.div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                While many companies pursue generic AI tools, heavily regulated
                industries need something different. A general-purpose assistant
                cannot safely navigate healthcare administration or tax exposure
                analysis.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-10">
                We build from the ground up — starting with deep workflow
                mapping. By understanding exactly how a compliance officer or
                allied health professional works, we insert automation precisely
                where it reduces friction, without compromising accuracy or data
                security.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg mb-10 max-w-xl mx-auto">
              We engage with a small number of partners to ensure deep focus and
