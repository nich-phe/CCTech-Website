          ...
          >
            <MouseTilt>
              ...
              >
                ...
                {/* ── Floating card: hours saved (top-left) ── */}
                <motion.div
                  className="absolute top-5 left-5 flex items-center gap-3 px-4 py-3"
                ...
                {/* ── Floating card: new referral notification (bottom-left) ── */}
                <motion.div
